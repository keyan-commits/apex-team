...
- **UX Ticket** — per-role identifier (`UX-NNNN`, zero-padded 4-digit).
- **FEAT** — parent feature identifier.
- **US** — parent user story.
- **Spec file** — relative path from `design/features/`.
- **Status** — `drafting` | `ready` | `in-implementation` | `reviewed`.
...
## UX ticket numbering allocation log
